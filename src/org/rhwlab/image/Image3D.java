...
public class Image3D extends MouseAdapter
    ...
    private void buildColorControlGUI() {
        ...
        */
        ...
        overlayMinZSlider = new JSlider(JSlider.HORIZONTAL, 0, iNucleiMgr.getPlaneEnd(), viewConfig.DEFAULT_OVERLAY_MIN_Z);
        ...
        overlayMaxZSlider = new JSlider(JSlider.HORIZONTAL, 0, iNucleiMgr.getPlaneEnd(), iNucleiMgr.getPlaneEnd());
    ...
    public void stateChanged(ChangeEvent e) {
        ...
        if(   o == overlayMinXSlider || o == overlayMinYSlider || o == overlayMinZSlider 
           ...
           viewConfig.setOverlayXYZChanged(true); 
        	...
        	geometryManager.setSphereScale((double)(iSphereScale.getValue()/100.));
    }
